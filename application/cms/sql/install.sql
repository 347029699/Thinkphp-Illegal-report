...
-- 表结构 `jd_cms_advert`
-- -----------------------------
DROP TABLE IF EXISTS `jd_cms_advert`;
...
-- -----------------------------
-- 表结构 `jd_cms_advert_type`
-- -----------------------------
DROP TABLE IF EXISTS `jd_cms_advert_type`;
...
-- -----------------------------
-- 表数据 `jd_cms_advert_type`
-- -----------------------------

-- -----------------------------
-- 表结构 `jd_cms_column`
-- -----------------------------
DROP TABLE IF EXISTS `jd_cms_column`;
...
-- 表结构 `jd_cms_document`
-- -----------------------------
DROP TABLE IF EXISTS `jd_cms_document`;
...
-- 表结构 `jd_cms_field`
-- -----------------------------
DROP TABLE IF EXISTS `jd_cms_field`;
...
-- 表数据 `jd_cms_field`
-- -----------------------------
INSERT INTO `jd_cms_field` VALUES ('1', 'id', 'ID', 'text', 'int(11) UNSIGNED NOT NULL', '0', '', 'ID', '0', '0', '0', '', '', '', '', '', '0', '', '', '', '', '1480562978', '1480562978', '100', '1');
INSERT INTO `jd_cms_field` VALUES ('2', 'cid', '栏目', 'select', 'int(11) UNSIGNED NOT NULL', '0', '', '请选择所属栏目', '0', '0', '0', '', '', '', '', '', '0', '', '', '', '', '1480562978', '1480562978', '100', '1');
INSERT INTO `jd_cms_field` VALUES ('3', 'uid', '用户ID', 'text', 'int(11) UNSIGNED NOT NULL', '0', '', '', '0', '0', '0', '', '', '', '', '', '0', '', '', '', '', '1480563110', '1480563110', '100', '1');
INSERT INTO `jd_cms_field` VALUES ('4', 'model', '模型ID', 'text', 'int(11) UNSIGNED NOT NULL', '0', '', '', '0', '0', '0', '', '', '', '', '', '0', '', '', '', '', '1480563110', '1480563110', '100', '1');
INSERT INTO `jd_cms_field` VALUES ('5', 'title', '标题', 'text', 'varchar(128) NOT NULL', '', '', '文档标题', '0', '1', '0', '', '', '', '', '', '0', '', '', '', '', '1480575844', '1480576134', '1', '1');
INSERT INTO `jd_cms_field` VALUES ('6', 'shorttitle', '简略标题', 'text', 'varchar(32) NOT NULL', '', '', '简略标题', '0', '1', '0', '', '', '', '', '', '0', '', '', '', '', '1480575844', '1480576134', '1', '1');
INSERT INTO `jd_cms_field` VALUES ('7', 'flag', '自定义属性', 'checkbox', 'set(\'j\',\'p\',\'b\',\'s\',\'a\',\'f\',\'h\',\'c\') NULL DEFAULT NULL', '', 'j:跳转\r\np:图片\r\nb:加粗\r\ns:滚动\r\na:特荐\r\nf:幻灯\r\nh:头条\r\nc:推荐', '自定义属性', '0', '1', '0', '', '', '', '', '', '0', '', '', '', '', '1480671258', '1480671258', '100', '1');
INSERT INTO `jd_cms_field` VALUES ('8', 'view', '阅读量', 'text', 'int(11) UNSIGNED NOT NULL', '0', '', '', '0', '1', '0', '', '', '', '', '', '0', '', '', '', '', '1480563149', '1480563149', '100', '1');
INSERT INTO `jd_cms_field` VALUES ('9', 'comment', '评论数', 'text', 'int(11) UNSIGNED NOT NULL', '0', '', '', '0', '0', '0', '', '', '', '', '', '0', '', '', '', '', '1480563189', '1480563189', '100', '1');
INSERT INTO `jd_cms_field` VALUES ('10', 'good', '点赞数', 'text', 'int(11) UNSIGNED NOT NULL', '0', '', '', '0', '0', '0', '', '', '', '', '', '0', '', '', '', '', '1480563279', '1480563279', '100', '1');
INSERT INTO `jd_cms_field` VALUES ('11', 'bad', '踩数', 'text', 'int(11) UNSIGNED NOT NULL', '0', '', '', '0', '0', '0', '', '', '', '', '', '0', '', '', '', '', '1480563330', '1480563330', '100', '1');
INSERT INTO `jd_cms_field` VALUES ('12', 'mark', '收藏数量', 'text', 'int(11) UNSIGNED NOT NULL', '0', '', '', '0', '0', '0', '', '', '', '', '', '0', '', '', '', '', '1480563372', '1480563372', '100', '1');
INSERT INTO `jd_cms_field` VALUES ('13', 'create_time', '创建时间', 'datetime', 'int(11) UNSIGNED NOT NULL', '0', '', '', '0', '0', '0', '', '', '', '', '', '0', '', '', '', '', '1480563406', '1480563406', '100', '1');
INSERT INTO `jd_cms_field` VALUES ('14', 'update_time', '更新时间', 'datetime', 'int(11) UNSIGNED NOT NULL', '0', '', '', '0', '0', '0', '', '', '', '', '', '0', '', '', '', '', '1480563432', '1480563432', '100', '1');
INSERT INTO `jd_cms_field` VALUES ('15', 'sort', '排序', 'text', 'int(11) NOT NULL', '100', '', '', '0', '1', '0', '', '', '', '', '', '0', '', '', '', '', '1480563510', '1480563510', '100', '1');
INSERT INTO `jd_cms_field` VALUES ('16', 'status', '状态', 'radio', 'tinyint(2) UNSIGNED NOT NULL', '1', '0:禁用\r\n1:启用', '', '0', '1', '0', '', '', '', '', '', '0', '', '', '', '', '1480563576', '1480563576', '100', '1');
INSERT INTO `jd_cms_field` VALUES ('17', 'trash', '回收站', 'text', 'tinyint(2) UNSIGNED NOT NULL', '0', '', '', '0', '0', '0', '', '', '', '', '', '0', '', '', '', '', '1480563576', '1480563576', '100', '1');

-- -----------------------------
-- 表结构 `jd_cms_link`
-- -----------------------------
DROP TABLE IF EXISTS `jd_cms_link`;
...
-- 表结构 `jd_cms_menu`
-- -----------------------------
DROP TABLE IF EXISTS `jd_cms_menu`;
...
-- 表数据 `jd_cms_menu`
-- -----------------------------
INSERT INTO `jd_cms_menu` VALUES ('1', '1', '0', '0', '0', '2', '首页', 'cms/index/index', '', '', '_self', '1492345605', '1492345605', '100', '1');
INSERT INTO `jd_cms_menu` VALUES ('2', '2', '0', '0', '0', '2', '关于我们', 'http://www.###.com', '', '', '_self', '1492346763', '1492346763', '100', '1');
INSERT INTO `jd_cms_menu` VALUES ('3', '3', '0', '0', '0', '2', '开发文档', 'http://www.###.cn/', '', '', '_self', '1492346812', '1492346812', '100', '1');
INSERT INTO `jd_cms_menu` VALUES ('4', '3', '0', '0', '0', '2', '开发者社区', 'http://bbs.###.com/', '', '', '_self', '1492346832', '1492346832', '100', '1');
INSERT INTO `jd_cms_menu` VALUES ('5', '1', '0', '0', '0', '2', '二级菜单', 'http://www.###.com', '', '', '_self', '1492347372', '1492347510', '100', '1');
INSERT INTO `jd_cms_menu` VALUES ('6', '1', '5', '0', '0', '2', '子菜单', 'http://www.###.com', '', '', '_self', '1492347388', '1492347520', '100', '1');

-- -----------------------------
-- 表结构 `jd_cms_model`
-- -----------------------------
DROP TABLE IF EXISTS `jd_cms_model`;
...
-- 表结构 `jd_cms_nav`
-- -----------------------------
DROP TABLE IF EXISTS `jd_cms_nav`;
...
-- 表数据 `jd_cms_nav`
-- -----------------------------
INSERT INTO `jd_cms_nav` VALUES ('1', 'main_nav', '顶部导航', '1492345083', '1492345083', '1');
INSERT INTO `jd_cms_nav` VALUES ('2', 'about_nav', '底部关于', '1492346685', '1492346685', '1');
INSERT INTO `jd_cms_nav` VALUES ('3', 'support_nav', '服务与支持', '1492346715', '1492346715', '1');

-- -----------------------------
-- 表结构 `jd_cms_page`
-- -----------------------------
DROP TABLE IF EXISTS `jd_cms_page`;
...
-- 表结构 `jd_cms_slider`
-- -----------------------------
DROP TABLE IF EXISTS `jd_cms_slider`;
...
-- 表结构 `jd_cms_support`
-- -----------------------------
DROP TABLE IF EXISTS `jd_cms_support`;
