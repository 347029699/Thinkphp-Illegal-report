...
//                ['mobile', '手机号'],
            ...
            ->addFilterList('role',$role_list)
            ->addTopButtons('add,enable,disable,delete') // 批量添加顶部按钮
            ->addRightButton('custom', $btn_access) // 添加授权按钮
            ->addRightButtons('edit,delete') // 批量添加右侧按钮
            ->replaceRightButton(['id' => 1], '<a title="" icon="fa fa-pencil" class="btn btn-xs btn-default" href="/admin.php/user/index/edit/id/1.html" target="_self" _tag="edit" data-toggle="tooltip" data-original-title="编辑"><i class="fa fa-pencil"></i></a>')
//            ->addOrder('exp')
