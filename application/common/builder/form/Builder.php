            ...
            foreach ($items as $key =>  $item) {
                switch ($item['type']) {
                    ...
                    case 'select':
                        ...
                        break;
                    case 'bmap':
                        if (!isset($item['ak']) || empty($item['ak']) ) {
                            $res = Config();
                            $items[$key]['ak'] = $res['bmap']['default']['ak'];
                        }
                        break;
                }
                if ($item['type'] == 'group') {
        ...
        if ($type != '') {
            switch ($type) {
                ...
                case 'editormd':
                    ...
                    break;
                case 'filetext':
                    $this->_vars['_js_files'][]  = 'filetext_js';
                    $this->_vars['_css_files'][] = 'filetext_css';
                case 'filebig':
                    $this->_vars['_js_files'][]  = 'filebig_js';
                    $this->_vars['_css_files'][] = 'filebig_css';
                case 'images':
