<?php /*a:6:{s:65:"D:\phpstudy_pro\WWW\test\application\admin\view\plugin\index.html";i:1589356742;s:59:"D:\phpstudy_pro\WWW\test\application\admin\view\layout.html";i:1612252485;s:47:"../application/common/builder/aside/layout.html";i:1589356742;s:54:"../application/common/builder/aside/blocks/recent.html";i:1589356742;s:54:"../application/common/builder/aside/blocks/online.html";i:1589356742;s:54:"../application/common/builder/aside/blocks/switch.html";i:1589356742;}*/ ?>
<!DOCTYPE html>
                        ...
                        <div class="row push-20">
                            <div class="col-md-12">
                                ...
                                <div class="toolbar-btn-action">
                                    <a title="全部" class="btn btn-default" href="<?php echo url('index'); ?>">全部(<?php echo htmlentities((isset($total['all']) && ($total['all'] !== '')?$total['all']:'0')); ?>)</a>
                                    <a title="已启用" class="btn btn-success" href="<?php echo url('index', ['status' => '1']); ?>">已启用(<?php echo htmlentities((isset($total['1']) && ($total['1'] !== '')?$total['1']:'0')); ?>)</a>
                                    <a title="已禁用" class="btn btn-warning" href="<?php echo url('index', ['status' => '0']); ?>">已禁用(<?php echo htmlentities((isset($total['0']) && ($total['0'] !== '')?$total['0']:'0')); ?>)</a>
                                    <a title="未安装" class="btn btn-info" href="<?php echo url('index', ['status' => '-1']); ?>">未安装(<?php echo htmlentities((isset($total['-1']) && ($total['-1'] !== '')?$total['-1']:'0')); ?>)</a>
                                    <a title="已损坏" class="btn btn-danger" href="<?php echo url('index', ['status' => '-2']); ?>" id="hide_disable">已损坏(<?php echo htmlentities((isset($total['-2']) && ($total['-2'] !== '')?$total['-2']:'0')); ?>)</a>
                                </div>
                            </div>
                        </div>
                        <div class="row module-list push-20">
                            ...
                            <div class="col-sm-6 col-md-4 col-lg-3">
                                <div class="block block-rounded">
                                    <div class="block-content block-content-full text-center bg-<?php echo htmlentities((isset($plugin['bg_color']) && ($plugin['bg_color'] !== '')?$plugin['bg_color']:'danger')); ?> ribbon ribbon-bookmark ribbon-crystal">
                                        <div class="ribbon-box font-w600"><?php echo htmlentities((isset($plugin['version']) && ($plugin['version'] !== '')?$plugin['version']:'无版本号')); ?></div>
                                        <div class="item item-2x item-circle bg-crystal-op push-20-t push-20 visibility-hidden" data-toggle="appear" data-offset="50" data-class="animated fadeIn">
                                            <i class="<?php echo htmlentities((isset($plugin['icon']) && ($plugin['icon'] !== '')?$plugin['icon']:'fa fa-puzzle-piece')); ?> text-white-op"></i>
                                        </div>
                                        <h3 class="h4 text-white"><?php echo htmlentities((isset($plugin['title']) && ($plugin['title'] !== '')?$plugin['title']:'无插件标题')); ?></h3>
                                        <div class="text-white-op">
                                            <em><?php echo htmlentities((isset($plugin['name']) && ($plugin['name'] !== '')?$plugin['name']:'')); ?></em>
                                        </div>
                                    </div>
                                    <div class="block-content bg-gray-lighter">
                                        <div class="<?php echo htmlentities($plugin['status_class']); ?> pull-right push-10-l"><?php echo $plugin['status_info']; ?></div>
                                        <div class="push-10">
                                            <a class="h5" href="<?php echo htmlentities((isset($plugin['author_url']) && ($plugin['author_url'] !== '')?$plugin['author_url']:'')); ?>" target="_blank"><i class="fa fa-user"></i> <?php echo htmlentities((isset($plugin['author']) && ($plugin['author'] !== '')?$plugin['author']:'')); ?></a>
                                        </div>
                                    ...
                                    <div class="builder-table-wrapper" id="builder-table-wrapper">
                                        <div class="builder-table" id="builder-table">
                                            <table class="table table-builder table-hover table-bordered table-striped">
                                                ...
                                                <tr>
                                                    <td><?php echo htmlentities((isset($plugin['title']) && ($plugin['title'] !== '')?$plugin['title']:'无插件标题')); ?></td>
                                                    <td><i class="<?php echo htmlentities((isset($plugin['icon']) && ($plugin['icon'] !== '')?$plugin['icon']:'fa fa-puzzle-piece')); ?>"></i></td>
                                                    <td><?php echo htmlentities((isset($plugin['version']) && ($plugin['version'] !== '')?$plugin['version']:'无版本号')); ?></td>
                                                    <td><a href="<?php echo htmlentities((isset($plugin['author_url']) && ($plugin['author_url'] !== '')?$plugin['author_url']:'')); ?>" target="_blank"><?php echo htmlentities((isset($plugin['author']) && ($plugin['author'] !== '')?$plugin['author']:'')); ?></a></td>
                        ...
                        <div class="data-table-toolbar">
                            <div class="row">
                                <div class="col-sm-12">
                                    ...
                                    <?php echo htmlentities($pages); ?>
                                    <?php endif; if(!(empty($row_list) || (($row_list instanceof \think\Collection || $row_list instanceof \think\Paginator ) && $row_list->isEmpty()))): ?>
                                    <div class="pagination-info pull-right">
                                        <form action="" method="get">
                                            ...
                                            / <strong><?php echo htmlentities($row_list->lastPage()); ?></strong> 页，共 <strong><?php echo htmlentities($row_list->total()); ?></strong> 条数据，每页显示数量
                                        </form>
                                    </div>
                                    <?php endif; ?>
                                </div>
