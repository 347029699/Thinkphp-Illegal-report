<?php /*a:6:{s:63:"D:\phpstudy_pro\WWW\test\application\admin\view\menu\index.html";i:1589356742;s:59:"D:\phpstudy_pro\WWW\test\application\admin\view\layout.html";i:1612252485;s:47:"../application/common/builder/aside/layout.html";i:1589356742;s:54:"../application/common/builder/aside/blocks/recent.html";i:1589356742;s:54:"../application/common/builder/aside/blocks/online.html";i:1589356742;s:54:"../application/common/builder/aside/blocks/switch.html";i:1589356742;}*/ ?>
<!DOCTYPE html>
...
<link href="/test/public/static/libs/jquery-nestable/jquery.nestable.css" rel="stylesheet" type="text/css" />
...
<script src="/test/public/static/libs/jquery-nestable/jquery.nestable.js"></script>
<script src="/test/public/static/libs/jquery-ui/jquery-ui.min.js"></script>
<script>
        ...
        $('#save').click(function(){
            ...
            $.post("<?php echo url('save'); ?>", {menus: $('#menu_list').nestable('serialize')}, function(data) {
                ...
                if (data.code) {
                    ...
                    Ma.notify(data.msg, 'success');
                } else {
                    Ma.notify(data.msg, 'danger');
                }
            });
        });
