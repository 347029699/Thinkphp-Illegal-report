<?php /*a:6:{s:65:"D:\phpstudy_pro\WWW\test\application\admin\view\module\index.html";i:1589356742;s:59:"D:\phpstudy_pro\WWW\test\application\admin\view\layout.html";i:1612252485;s:47:"../application/common/builder/aside/layout.html";i:1589356742;s:54:"../application/common/builder/aside/blocks/recent.html";i:1589356742;s:54:"../application/common/builder/aside/blocks/online.html";i:1589356742;s:54:"../application/common/builder/aside/blocks/switch.html";i:1589356742;}*/ ?>
<!DOCTYPE html>
                        ...
                        <div class="row module-list push-20">
                            ...
                            <div class="col-sm-6 col-md-4 col-lg-3">
                                <div class="block block-rounded">
                                    <div class="block-content block-content-full text-center bg-<?php echo htmlentities((isset($module['bg_color']) && ($module['bg_color'] !== '')?$module['bg_color']:'danger')); ?> ribbon ribbon-bookmark ribbon-crystal">
                                        <div class="ribbon-box font-w600"><?php echo htmlentities((isset($module['version']) && ($module['version'] !== '')?$module['version']:'无版本号')); ?></div>
                                        <div class="item item-2x item-circle bg-crystal-op push-20-t push-20 visibility-hidden" data-toggle="appear" data-offset="50" data-class="animated fadeIn">
                                            <i class="<?php echo htmlentities((isset($module['icon']) && ($module['icon'] !== '')?$module['icon']:'fa fa-puzzle-piece')); ?> text-white-op"></i>
                                        </div>
                                        <h3 class="h4 text-white"><?php echo htmlentities((isset($module['title']) && ($module['title'] !== '')?$module['title']:'无模块标题')); ?></h3>
                                        <div class="text-white-op">
                                            <em><?php echo htmlentities((isset($module['name']) && ($module['name'] !== '')?$module['name']:'')); ?></em>
                                        </div>
                                    </div>
                                    <div class="block-content bg-gray-lighter">
                                        <div class="<?php echo htmlentities($module['status_class']); ?> pull-right push-10-l"><?php echo $module['status_info']; ?></div>
                                        <div class="push-10">
                                            <a class="h5" href="<?php echo htmlentities((isset($module['author_url']) && ($module['author_url'] !== '')?$module['author_url']:'')); ?>" target="_blank"><i class="fa fa-user"></i> <?php echo htmlentities((isset($module['author']) && ($module['author'] !== '')?$module['author']:'')); ?></a>
                                        </div>
                                    ...
                                    <div class="builder-table-wrapper" id="builder-table-wrapper">
                                        <div class="builder-table" id="builder-table">
                                            <table class="table table-builder table-hover table-bordered table-striped">
                                                ...
                                                <tr>
                                                    <td><?php echo htmlentities((isset($module['title']) && ($module['title'] !== '')?$module['title']:'无模块标题')); ?></td>
                                                    <td><i class="<?php echo htmlentities((isset($module['icon']) && ($module['icon'] !== '')?$module['icon']:'fa fa-puzzle-piece')); ?>"></i></td>
                                                    <td><?php echo htmlentities((isset($module['version']) && ($module['version'] !== '')?$module['version']:'无版本号')); ?></td>
                                                    <td><a href="<?php echo htmlentities((isset($module['author_url']) && ($module['author_url'] !== '')?$module['author_url']:'')); ?>" target="_blank"><?php echo htmlentities((isset($module['author']) && ($module['author'] !== '')?$module['author']:'')); ?></a></td>
