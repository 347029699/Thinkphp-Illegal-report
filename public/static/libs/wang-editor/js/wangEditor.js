...
_e(function (E, $) {
    ...
    E.createMenu(function (check) {
        ...
        var $heightInput = $('<input type="text" value="100%" style="width:50px;text-align:center;"/>');
        ...
        $btnSubmit.click(function (e) {
            ...
            var $link;
            var width = $widthInput.val();//parseInt($widthInput.val());
            var height = $heightInput.val();//parseInt($heightInput.val());
            var $div = $('<div>');
