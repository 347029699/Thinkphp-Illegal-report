...
return [
    ...
    'core_css' => [ // 默认加载
        ...
        "__ADMIN_CSS__/admin/css/ma.css",
    ],
    'libs_js' => [ // 默认加载
    ...
    'wangeditor_js' => [ // wang编辑器
        "__LIBS__/wang-editor/js/wangEditor.js",
    ],
    ...
    'filetext_js'=>[
        "__EXTEND_FORM__/filetext/filetext.js",
    ],
    'filetext_css'=>[
        "__EXTEND_FORM__/filetext/filetext.css",
    ],
    'filebig_js'=>[
        "__EXTEND_FORM__/filebig/filebig.js",
    ],
    'filebig_css'=>[
        "__EXTEND_FORM__/filebig/filebig.css",
    ],
];
